...
public class PanelPerfil extends JPanel {
	...
	private JButton btnUsuario, btnMetodoDePago, btnCerrarSesion, btnProducto;
	...
	private final Color COLOR_BOTON_PRODUCTO = new Color(227, 71, 36);
	...
	public void inicializarComponentes() {
		...
		panelImagen.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(COLOR_BORDE_CAMPO, 1),
		...
		lblImagenPerfil.setText("<html><div style='text-align: center; color: #999; font-family: Arial;'>"
				...
				+ "<div style='font-size: 16px; font-weight: bold;'>IMAGEN DE PERFIL</div>" + "</html>");
		...
		// Botón de Productos
		btnProducto = new JButton("Productos Creados");
		btnProducto.setFont(new Font("Arial", Font.BOLD, 16));
		btnProducto.setBackground(COLOR_BOTON_PRODUCTO);
		btnProducto.setForeground(Color.WHITE);
		btnProducto.setBorder(BorderFactory.createEmptyBorder(12, 24, 12, 24));
		btnProducto.setFocusPainted(false);
		btnProducto.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
		btnProducto.setPreferredSize(new Dimension(250, 50));

		btnProducto.addMouseListener(new MouseAdapter() {
			public void mouseEntered(MouseEvent evt) {
				btnProducto.setBackground(new Color(192, 57, 43));
			}
